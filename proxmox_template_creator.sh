...
echo "=============================================="
echo "  Proxmox Cloud-Init Template Creator v2.0"
echo "=============================================="
echo ""
...
while true; do
    read -rp "Proceed with template creation? (y/n/edit) [y]: " CONFIRM
    CONFIRM=${CONFIRM:-y}
    case "$CONFIRM" in
        [Yy]*) break ;;
        [Nn]*) log_info "Aborted by user"; exit 0 ;;
        [Ee]*) log_info "Edit mode not implemented yet. Please restart script."; exit 0 ;;
        *) log_warn "Please answer y, n, or edit" ;;
    esac
done
...
echo "=============================================="
echo ""
log_ok "You can now clone this template to create new VMs"
echo ""